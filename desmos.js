...
let polygonsFromTxt = JSON.parse(fs.readFileSync("desmos_file.txt"));

// Paste Blender output into polygons array, then run the program in the Desmos Console

console.log(polygonsFromTxt);
  ...
  await page.evaluate((polys) => {
    ...
    state.expressions.list.push(
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "f_{1}\\left(x,y,\\theta\\right)=\\left(\\frac{d}{d-f_{2}\\left(x,y,\\theta\\right)\\cdot t_{oggle}}x\\cos\\left(a+\\theta\\right),\\frac{d}{d-f_{2}\\left(x,y,\\theta\\right)\\cdot t_{oggle}}\\left(x\\sin\\left(a_{2}\\right)\\sin\\left(a+\\theta\\right)+y\\cos\\left(a_{2}\\right)\\right)\\right)",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "f_{2}\\left(x,y,\\theta\\right)=x\\sin\\left(a+\\theta\\right)\\cos\\left(a_{2}\\right)-y\\sin\\left(a_{2}\\right)",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "f_{1c}\\left(x,y,z\\right)=f_{1}\\left(\\sqrt{x^{2}+z^{2}},y,\\tan^{-1}\\left(\\frac{z+.0001}{x}\\right)+\\left\\{x<0:1,0\\right\\}\\pi\\right)",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "f_{2c}\\left(x,y,z\\right)=f_{2}\\left(\\sqrt{x^{2}+z^{2}},y,\\tan^{-1}\\left(\\frac{z+.0001}{x}\\right)+\\left\\{x<0:1,0\\right\\}\\pi\\right)",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "c_{artesian}\\left(x,y,\\theta\\right)=\\left[x\\cos\\theta,y,x\\sin\\theta\\right]",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "p_{olygon}\\left(l_{ist}\\right)=\\left\\{w_{inding}\\left(c_{onvert}\\left(l_{ist}\\right)\\right)>0:\\operatorname{polygon}\\left(c_{onvert}\\left(l_{ist}\\right)\\right)\\right\\}",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "d_{epth}\\left(l_{ist}\\right)=\\operatorname{mean}\\left(\\operatorname{sort}\\left(\\left[f_{2c}\\left(l_{ist}\\left[3i+1\\right],l_{ist}\\left[3i+2\\right],l_{ist}\\left[3i+3\\right]\\right)\\operatorname{for}i=\\left[0...\\frac{\\operatorname{length}\\left(l_{ist}\\right)}{3}-1\\right]\\right]\\right)\\right)",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "c_{onvert}\\left(l_{ist}\\right)=\\left[f_{1c}\\left(l_{ist}\\left[3i+1\\right],l_{ist}\\left[3i+2\\right],l_{ist}\\left[3i+3\\right]\\right)\\operatorname{for}i=\\left[0...\\frac{\\operatorname{length}\\left(l_{ist}\\right)}{3}-1\\right]\\right]",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "c_{ross}\\left(A,B\\right)=\\left[A\\left[2\\right]B\\left[3\\right]-A\\left[3\\right]B\\left[2\\right],A\\left[3\\right]B\\left[1\\right]-A\\left[1\\right]B\\left[3\\right],A\\left[1\\right]B\\left[2\\right]-A\\left[2\\right]B\\left[1\\right]\\right]",
      },
      {
        type: "expression",
        folderId: "1",
        latex:
          "d_{ot}\\left(A,B\\right)=A\\left[1\\right]B\\left[1\\right]+A\\left[2\\right]B\\left[2\\right]+A\\left[3\\right]B\\left[3\\right]",
      },
      {
        type: "expression",
        folderId: "1",
        latex:
          "m_{agnitude}\\left(v\\right)=\\sqrt{v\\left[1\\right]^{2}+v\\left[2\\right]^{2}+v\\left[3\\right]^{2}}",
      },
      {
        type: "expression",
        folderId: "1",
        latex:
          "n_{ormalize}\\left(v\\right)=\\left[\\frac{v\\left[1\\right]}{m_{agnitude}\\left(v\\right)},\\frac{v\\left[2\\right]}{m_{agnitude}\\left(v\\right)},\\frac{v\\left[3\\right]}{m_{agnitude}\\left(v\\right)}\\right]",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "n_{ormal}\\left(l_{ist}\\right)=-c_{ross}\\left(\\operatorname{join}\\left(l_{ist}\\left[7\\right]-l_{ist}\\left[4\\right],l_{ist}\\left[8\\right]-l_{ist}\\left[5\\right],l_{ist}\\left[9\\right]-l_{ist}\\left[6\\right]\\right),\\operatorname{join}\\left(l_{ist}\\left[1\\right]-l_{ist}\\left[4\\right],l_{ist}\\left[2\\right]-l_{ist}\\left[5\\right],l_{ist}\\left[3\\right]-l_{ist}\\left[6\\right]\\right)\\right)",
      },
      {
        type: "text",
        folderId: "1",
      ...
      },
      {
        ...
        folderId: "1",
        latex:
          "s_{hadow}\\left(f_{ace}\\right)=.5+d_{ot}\\left(l_{ight},n_{ormalize}\\left(n_{ormal}\\left(f_{ace}\\right)\\right)\\right)\\cdot.5",
      }
    );
    ...
    for (let i = 0; i < n; i++) {
      myColors +=
        "\\operatorname{hsv}\\left(" +
        polygons[i].slice(1, 4) +
        "\\cdot s_{hadow}\\left(s_{" +
        i +
        "}\\right)\\right),";
    ...
    state.expressions.list.push(
      ...
      },
      {
        ...
        folderId: "4062",
        latex:
          "c_{olors}=\\operatorname{sort}\\left(\\left[" +
          myColors +
          "\\right],d_{epths}\\right)",
      },
      {
        type: "expression",
        folderId: "4062",
